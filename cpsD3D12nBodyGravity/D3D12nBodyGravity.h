...
// CPU,
// it has no understanding of the lifetime of resources on the GPU. Apps must
// account
// for the GPU lifetime of resources to avoid destroying objects that may still
// be
...
private:
  ...
  void LoadParticles(_Out_writes_(numParticles) Particle *pParticles,
                     const XMFLOAT3 &center, const XMFLOAT4 &velocity,
